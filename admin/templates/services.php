...
<?php endforeach; ?>      
	...
	<table id="sort_vars" class="tabl sort" cellspacing="1">
	  ...
	  $servard = array('Печать А3', 'Тампон ручки', 'Тампон кружки', 'Сублимация A4', 'Тиснение', 'Ширик', 'Постпечать', 'Интерьерка', 'Термо', 'Спот', 'Шелкуха', 'Закатка', 'Заливка', 'Флаги', 'Гравировка', 'Доделка 1', 'Доделка 2','Стенды', 'Оракал', 'Винил', 'Пакеты шелкуха', 'Штендеры', 'Дисконтки', 'Браслеты','Шелкография сетка'
	  );
	  $j = 1;
