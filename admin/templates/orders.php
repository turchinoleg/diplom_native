...
<div class="content">
	<h2>Заказы <span class="small">(необработанные заказы подсвечены серым, на рассмотрение подсвечены зеленым )</span></h2>
<?php
...
<tr <?php if($item['status'] == 0) echo "class='highlight'"; elseif($item['status'] == 2) echo "class='proceselight'"; ?> >
    <td><?=$item['order_id']?></td>
