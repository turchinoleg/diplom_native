...
<div class="serv-section" id="brelocks">
	...
	<div class="serv_content">
    	...
    	<p class="serv_tip">Расчет произведен на самые популярные модели брелоков.  Стоимость заготовки может увеличится на стоимость доработки брелока до готового изделия на 5-30 руб. в зависимости от вида и тиража.</p>
    	<p class="serv_tip">Стоимость подготовки макета для печати оплачивается отдельно, 100-500 руб. в зависимости от сложности.</p>
	</div>
</div>
<hr>
...
<div class="serv-section" id="dailybooks">
	...
	<div class="serv_content">
	    ...
	    <p class="serv_tip"></p>
	    <p class="serv_tip">Ежедневники и другая продукция может быть приобретена в «Аверс-стиль» или предоставлена заказчиком.</p>
...
<div class="serv-section" id="mirrors">
	...
	<div class="serv_content">
    	...
    	<p class="serv_tip">Зеркало металлическое компактное складное &asymp; 7x7 см с двумя зеркалами. Возможна допольнительная комплектация подарочной упаковкой</a>.</p>
